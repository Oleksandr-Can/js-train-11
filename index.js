...
function addElements(mySet, arr) {
  ...
  Array.from(arr, value => mySet.add(value))
...
function setToArray(mySet) {
  ...
  const result = arr.filter(value => typeof value === "string");
...
console.log(areDisjoint(new Set([1, 2, 3]), new Set([6, 4, 5])));
// Виведе: false
...
function iterateSet(set) {
  ...
  for (const value of iterEntries) {
